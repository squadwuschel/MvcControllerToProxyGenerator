 ...
 formData.append('datei', datei); 
    ...
    public getDownloadNoParams() : void  { 
     ...
     public addTsEntryAndParams(person: ProxyGeneratorDemoPage.Models.Person.Models.IPerson,name: string,vorname: string) : Observable<ProxyGeneratorDemoPage.Models.Person.Models.IAuto> { 
            return this.http.post('Proxy/AddTsEntryAndParams'+ '?name='+encodeURIComponent(name)+'&vorname='+encodeURIComponent(vorname),person).map((response: Response)  => <ProxyGeneratorDemoPage.Models.Person.Models.IAuto>response.json() as ProxyGeneratorDemoPage.Models.Person.Models.IAuto);
     } 
     ...
     public loadTsCallByParamsAndId(name: string,vorname: string,alter: number,id: number) : Observable<ProxyGeneratorDemoPage.Models.Person.Models.IAuto> { 
            return this.http.get('Proxy/LoadTsCallByParamsAndId' + '/' + id+ '?name='+encodeURIComponent(name)+'&vorname='+encodeURIComponent(vorname)+'&alter='+alter).map((response: Response)  => <ProxyGeneratorDemoPage.Models.Person.Models.IAuto>response.json() as ProxyGeneratorDemoPage.Models.Person.Models.IAuto);
     } 
     ...
     public loadAllAutosArray(name: string) : Observable<ProxyGeneratorDemoPage.Models.Person.Models.IAuto[]> { 
            return this.http.get('Proxy/LoadAllAutosArray'+ '?name='+encodeURIComponent(name)).map((response: Response)  => <ProxyGeneratorDemoPage.Models.Person.Models.IAuto[]>response.json() as ProxyGeneratorDemoPage.Models.Person.Models.IAuto[]);
     } 
