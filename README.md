...
Be carefull on updating the package, save your custom settings first, because on updating this package will replace your settings for ProxyGenerator or use the **web.config** to store your Settings.
